...
import com.qilihui.forum.service.IMailService;
import com.qilihui.forum.service.UserInfoService;
import com.qilihui.forum.util.RedisUtil;
...
public class EmailCheckController {
    ...
    public ForumResult emailCheck(@RequestParam("emailTo") String emailTo, HttpServletRequest request) {
        ...
        try {
            ...
            mailService.sendSimpleMail(emailTo, "在线学习论坛 邮箱验证", "您的邮箱验证码为：" + randomCode + "（15分钟后失效）");
