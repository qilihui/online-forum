...
import com.qilihui.forum.pojo.vo.QuestionVO;
...
public class QuestionController {
    ...
    @GetMapping("/getAllQuestionWithFollow")
    @ResponseBody
    public ForumResult getAllQuestionWithFollow(@RequestParam(defaultValue = "1", value = "currPage") Integer currPage,
                                                @RequestParam(defaultValue = "5", value = "pageSize") Integer pageSize, HttpSession httpSession) {
        PageHelper.startPage(currPage, pageSize);
        int uid = (int) httpSession.getAttribute("uid");
        List<Question> questions = questionService.getAllQuestionWithFollow(uid);
        return getForumResult(questions);
    }
    ...
    public ForumResult getForumResult(List<Question> questions) {
        List<QuestionVO> res = new ArrayList<>();
     ...
     * @return 包装结果
     */
    @GetMapping("/getFollowArticleCount")
    @ResponseBody
    public ForumResult getFollowArticleCount(HttpSession httpSession) {
        int uid = (int) httpSession.getAttribute("uid");
        List<Question> list = questionService.getAllQuestionWithFollow(uid);
        return new ForumResult(200, "查询成功", list.size());
    }
