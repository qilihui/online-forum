...
import com.qilihui.forum.mapper.CommentNoticeInfoMapper;
import com.qilihui.forum.mapper.CommentReplyMapper;
...
public class CommentReplyServiceImpl implements CommentReplyService {
    ...
    @Override
    @Transactional
    public CommentReply insertCommentReply(Integer qId, String username, String content, Integer parentCommentId, String replyfor) throws ContentNoLegalException {
        if (!baiduTextUtil.textIsNormal(content)){
