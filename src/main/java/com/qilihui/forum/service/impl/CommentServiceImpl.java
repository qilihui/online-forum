...
public class CommentServiceImpl implements CommentService {
    ...
    @Autowired
    public CommentServiceImpl(CommentNoticeInfoMapper commentNoticeInfoMapper, CommentMapper commentMapper, QuestionMapper questionMapper, UserInfoMapper userInfoMapper, UserRateMapper userRateMapper, BaiduTextUtil baiduTextUtil) {
    ...
    @Override
    @Transactional
    public Comment insertCommentByQuestionId(String username, String comment, Integer questionId) throws ContentNoLegalException {
        if (!baiduTextUtil.textIsNormal(comment)){
            throw new ContentNoLegalException();
        }
