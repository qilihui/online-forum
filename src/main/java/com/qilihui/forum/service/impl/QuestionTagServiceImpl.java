...
import com.qilihui.forum.mapper.QuestionTagMapper;
import com.qilihui.forum.pojo.QuestionTag;
import com.qilihui.forum.service.QuestionTagService;
...
public class QuestionTagServiceImpl implements QuestionTagService {
    ...
    @Override
    public int displayQuestionTag(int questionId) {
        return questionTagMapper.displayQuestionTag(questionId);
    }
}
